"""Unit tests for EventInvitation GraphQL entity mutation delegates."""
...
def _info_with_services(*, invitation_service=None):
    services = types.SimpleNamespace(EventInvitationService=invitation_service)
