...
# Test case to verify GraphQL response
@pytest.mark.asyncio
...
# Import utility functions for query operations
...
# Import GraphQL resolvers for different models
...
# Import permission classes for access control
...
# Define test cases for disciplines
...
# Define test cases for discipline sets
...
# Define test cases for summaries
...
# Test that `get_table_resolvers` raises NotImplementedError
