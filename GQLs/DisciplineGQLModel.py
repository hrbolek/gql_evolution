...
class DisciplineGQLModel(BaseGQLModel):
    ...
    @strawberry.field(description="Returns a discipline sets for the discipline")
    ...
    @strawberry.field(description="Returns results of the discipline")
    ...
    @strawberry.field(description="Returns a result templates of the discipline")
    async def templates(self, info: strawberry.types.Info, id: uuid.UUID) -> typing.List[SummaryGQLModel]:
        from .SummaryGQLModel import SummaryGQLModel
        result = await DisciplineGQLModel.load_with_loader(info=info, id=id)
        return result
    
    @strawberry.field(description="Returns a norms of the discipline")
